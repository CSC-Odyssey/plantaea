...
export default function createPlantTag(isMedicine, isFood, isAromatic) {
    return (
        <View style={{flexDirection:'row'}}>
            {isMedicine == true? 
                <View style={{backgroundColor:'#F37373', alignItems:'center', borderRadius:8, paddingHorizontal:5,paddingVertical:1,marginTop:2,marginRight:2.5}}><Text style={{fontSize:8, color:'white'}}>Medicine</Text></View>
                :
                null
            }
            {isFood == true? 
